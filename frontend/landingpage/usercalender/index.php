...
<body>
    <header class="navbar">
        ...
        ?>
        <a href="../home.php?page_id=<?php echo $id ?>"> <label id="owner" style="color: white; text-align: justify; font-weight: bold; white-space: nowrap; cursor: pointer; text-transform: capitalize;">
    ...
    <footer>
       ...
       Where admin_id = $id;");
        ...
        <div class="copy-right">
            <hr>
            <p>&copy; 2024 Herald | Student. All Rights Reserved.</p>
        </div>
    </footer>
                ...
                dayClick: function(date, jsEvent, view) {
                    ...
                    if (date.isBefore(today, 'day')) {
                        ...
                        Swal.fire({
                            ...
                            text: 'Do you want to make a reservation for ' + clickedDate + '?',
                            icon: 'question',
                                        ...
                                        Swal.fire({
                                            ...
                                            if (result.isConfirmed) {
                                                ...
                                                window.location.href =
                                                    'http://localhost/Banquet-house/frontend/landingpage/home.php?page_id=' +
                                                    pageId;
                                            }
                                        });
                                    },
